...
def efficientnet(width_coefficient=None, depth_coefficient=None, dropout_rate=0.5,
                 drop_connect_rate=0.5, image_size=None, num_classes=1):
